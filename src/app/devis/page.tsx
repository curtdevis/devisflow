    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="max-w-3xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link
            href={dashboardHref}
            className="text-sm font-semibold px-4 py-2 rounded-lg text-white border border-white/30 hover:bg-white/10 transition-colors"
          >
            Mon espace →
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-10 print:p-0 print:max-w-none">
        ...
        <div
          className="print-hidden flex items-center justify-between gap-3 rounded-xl px-5 py-4 mb-8 text-white"
          style={{ backgroundColor: "var(--navy)" }}
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm">
                Imprimez ou envoyez, puis retrouvez-le dans votre dashboard.
              </p>
            </div>
          </div>
          <Link
            href="/dashboard"
            className="shrink-0 text-sm font-semibold px-4 py-2 rounded-lg border border-white/30 hover:bg-white/10 transition-colors whitespace-nowrap"
          >
            Mon dashboard →
          </Link>
        </div>
