...
const faqs = [
  ...
  },
  {
    ...
    a: "Le plan Cabinet & Groupement inclut la gestion de jusqu'à 50 artisans et 500 devis générés par mois pour l'ensemble de votre portefeuille, ce qui couvre confortablement aussi bien un petit cabinet de 5 artisans qu'une fédération régionale qui en compte plusieurs dizaines. Chaque artisan invité conserve son propre compte pour créer ses devis, pendant que l'administrateur du cabinet ou du groupement garde une vue consolidée sur l'ensemble du portefeuille depuis un tableau de bord unique. Le tarif exact dépend du nombre d'artisans réellement gérés : DevisFlow propose un devis personnalisé à partir de 299 €/mois plutôt qu'un prix fixe, avec une facturation regroupée sur un seul abonnement mensuel. Besoin de gérer un volume supérieur à 50 artisans ? Contactez l'équipe DevisFlow via le formulaire de contact pour obtenir un forfait adapté à votre volume exact.",
  },
  {
